...
Tanto el repositorio como la solución del proyecto deberán estar nombrado TPWinForm_EquipoX; siendo la sintaxis de GitHub tp-winform-equipo-x y la de la solución TPWinForm_equipo-x
